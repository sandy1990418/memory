...
DISTILL_BATCH="${LME_DISTILL_BATCH:-2}"
LIGHTMEM="${LME_LIGHTMEM:-1}"
RESOLVER_MODE="${LME_RESOLVER_MODE:-offline}"
DRAIN_MODE="${LME_DRAIN_MODE:-after_run}"
OFFICIAL_BATCHING="${LME_OFFICIAL_BATCHING:-1}"
SERVICE_WORKERS="${LME_SERVICE_WORKERS:-2}"
AUTO_PREP_RETRY="${LME_AUTO_PREP_RETRY:-1}"
SEARCH_K="${LME_SEARCH_K:-30}"
ANSWER_TOP_K="${LME_ANSWER_TOP_K:-10}"
